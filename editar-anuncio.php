...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    ?>
    <script type="text/javascript">window.location = 'meus-anuncios.php'</script>
    <?php
}
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <?php foreach ($info['fotos'] as $foto): ?>
                            <div class="foto_item">
                                <img src="assets/images/anuncios/<?php echo $foto['link']; ?>" class="img-thumbnail" border="0"> <br>
                                <a href="excluir-foto.php?id=<?php echo $foto['id']; ?>" class="btn btn-default">Excluir foto</a>
                            </div>
                        <?php endforeach;?>
